...
const Dashboard = () => {
    ...
    const fetchHistory = async () => {
        setIsLoading(true);
        try {
            const response = await axios.get(`${API_BASE_URL}/qr/history`, { withCredentials: true });
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await axios.delete(`${API_BASE_URL}/qr/${id}`, { withCredentials: true });
        ...
        <div className="app">
            <div className="navbar">
                ...
                <div className="navbar-center hidden lg:flex">
                    ...
                    <li><a className='text-lg '>History</a></li>
                    <li><a className='text-lg '>About</a></li>
                    </ul>
                </div>
                <div className="navbar-end">
                    <button onClick={handleLogin} className="btn bg-white text-black border-[#e5e5e5] mx-4 pt-3 pb-3">
            ...
            <div className='dashboard'>
                <div className="overflow-x-auto rounded-box border border-base-content/5 bg-base-100 mt-10 mx-4 lg:mx-10 xl:mx-20" 
                    ...
                    <table className="table text-xs md:text-base lg:text-lg">
                        <thead>
                            <tr>
                                <th className="text-xs md:text-base lg:text-lg">#</th>
                                ...
                                <th className="text-xs md:text-base lg:text-lg">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            {isLoading ? (
                                    ...
                                    <tr key={item.id} className="hover:bg-base-200/10">
                                        ...
                                        <td className="text-xs md:text-sm lg:text-base">
                                            <button
                                                ...
                                                className="btn btn-sm btn-ghost text-blue-400 hover:text-blue-300 hover:bg-blue-400/10"
                                            >
